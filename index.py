...
dataset = RadarSpectrogramDataset(root_dir=r"E:\SpectrogramFusion\11_class_activity_data", transform=transform)
...
def measure_resource_usage(model, input_shape=(1, 3, 224, 224)):
    ...
    for _ in range(timing_runs):
        _ = model(dummy_inputs)
    avg_inference_time = (time.time() - start_time) / timing_runs
